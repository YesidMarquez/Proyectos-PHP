...
$sql2 = "SELECT * FROM imagephp where movil_token = $token ";
...
<!-- ***************************************************INICIO DE AREA DE TRABAJO****************************************************--> 
    <div class="container-fluid"><br>
        ...
        <div class="row">
            <div class="col-sm-8">
                <img src="<?php echo ($row2['ruta_imagen']);?>" class="img-thumbnail" width="" height=""><br><br><br>
             </div>
            <div class="col-sm-4">
