<?php
   ...
   // conexión con la base de datos
    ...
    $sql2 = "SELECT  count(*) as conteo, id_registro FROM `movil` where registro BETWEEN '$fecha_ini' AND '$fecha_fin' ";
    $resultado2 = $mysqli->query($sql2);
    $row2 = $resultado2->fetch_array(MYSQLI_ASSOC);
   
    $sql3 = "SELECT  count(*) as conteo FROM `movil` where registro BETWEEN '$fecha_mes_inc' AND '$fecha1'";
    $resultado3 = $mysqli->query($sql3);
    $row3 = $resultado3->fetch_array(MYSQLI_ASSOC);

    $sql4 = "SELECT  count(*) as conteo FROM `movil`";
            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link" href="menu.php">
                        <img src="../../imagenes/iconos/ag10.png" title="Listado de Agentes" width="80" height="60"></img>
                    </a>
                </li>
                <li class="nav-item">
                                        ...
                                        <div class="col-3 ">
                                            <ul class="list-group">
                                              ...
                                              <li class="border badge badge-danger badge-pill">
                                                HISTORICO DE VENTAS  
                                                <span class="border badge badge-dark badge-pill"><?php echo $row4['conteo']; ?></span>
                                              </li>
                                            </ul>
                                        </div><br> 
                                    </div>                                     
