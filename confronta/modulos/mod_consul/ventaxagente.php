...
$sql = "SELECT *  FROM confronta c, usuarios u WHERE c.usuario_cedula = $idAgente and u.cedula_usuario= $idAgente";
...
$sql2 = "SELECT  count(*) as conteo, id_registro FROM `confronta` where registro BETWEEN '$fecha_ini' AND '$fecha_fin' and  usuario_cedula=$idAgente";
$resultado2 = $mysqli->query($sql2);
$row2 = $resultado2->fetch_array(MYSQLI_ASSOC);

$sql3 = "SELECT  count(*) as conteo FROM `confronta` where registro BETWEEN '$fecha_mes_inc' AND '$fecha1' and  usuario_cedula=$idAgente";
$resultado3 = $mysqli->query($sql3);
$row3 = $resultado3->fetch_array(MYSQLI_ASSOC);

$sql4 = "SELECT  count(*) as conteo FROM `confronta`where usuario_cedula=$idAgente";
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="../mod_insert/ventas.php">
                        <img  class="menu" src="../../imagenes/iconos/ventas.png" title="Nueva Venta">
                        </img>
                    </a>
                </li>
                <li class="nav-item">
            ...
            <div class="row">
                <div class="col-sm-2 ">
                    <ul class="list-group">
                        ...
                        <li class="badge badge-danger badge-pill">
                            HISTORICO DE VENTAS
                            <span class="badge badge-dark badge-pill"><?php echo $row4['conteo']; ?>
                            </span>
                        </li>
                    </ul>
                </div>
