<?php
   require("../mod_config/conexion.php");
    ...
    $sql1 = "SELECT usuario_cedula, registro, token_confronta, campana FROM confronta ";
    ...
    if($resultado->num_rows > 0 ){
        ...
        $tituloReporte = "Reporte Excel Confronta ";
        ...
        while ($fila = $resultado->fetch_array()) {
            $objPHPExcel->setActiveSheetIndex(0)
                    ...
                    ->setCellValue('C'.$i,  $fila['token_confronta'])
        ...
        $objPHPExcel->getActiveSheet()->setTitle('Datos Confronta');
