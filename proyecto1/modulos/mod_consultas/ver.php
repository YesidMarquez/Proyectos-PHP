...
<!-- ***************************************************INICIO DE AREA DE TRABAJO****************************************************--> 
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-3  ">
                <img src="../soportes/<?php echo $ruta; ?>" class="img-thumbnail" alt="Cinque Terre" width="304" height="236">
                    ...
                    <div id="myCarousel" class="carousel slide" data-ride="carousel">
                      ...
                      <div class="carousel-inner">
                        <div class="carousel-item active">
                          <img src="../soportes/<?php echo $ruta1; ?>" alt="Los Angeles" width="550" height="500">
                        </div>
                        <div class="carousel-item">
                          <img src="../soportes/<?php echo $ruta2; ?>" alt="Chicago" width="550" height="500">
                        </div>
                        <div class="carousel-item">
                          <img src="../soportes/<?php echo $ruta3; ?>" alt="New York" width="550" height="500">
                        </div>
                      </div>
