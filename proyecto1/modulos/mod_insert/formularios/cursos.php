...
<body style="background-color:#F0000;">
    ...
    <form class="form-horizontal" method="POST"  action="../inserciones/insertar_cursos.php">
        <div class="container">
            <div class="row">
                <div class="col">
                ...
                <div class="col">
                    ...
                    <input type="text" class="form-control" id="nro" name="nro" placeholder="NRO CURSO" onkeyup="mayus(this);" required>
