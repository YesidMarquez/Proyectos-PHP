...
<body style="background-color:#F0000;">
            ...
            <div class="col-sm-3">
                <form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST">
                    <div class="input-group">
                        <input type="text" id="campo" name="campo" class="form-control" placeholder="Cedula" />
    ...
    <div class="container">        
        <form class="form-horizontal" method="POST"  action="../inserciones/insertar_puesto.php">    
            <div class="row">
                <div class="col">
                    ...
                    <label for="estado_civil" class="control-label">Puesto</label>
                    ...
                    <label for="estado_civil" class="control-label">Cliente</label>
                ...
                <div class="col">
                    ...
                    <label class="control-label">Direccion Puesto</label>
                    <input type="text" class="form-control" id="dir_pto" name="dir_pto" placeholder="Direccion Puesto" required>


                    <label for="estado_civil" class="control-label">Ciudad</label>
                    ...
                    <label for="estado_civil" class="control-label">Modalidad</label>
                    ...
                    <input type="date" class="form-control" id="f_in" name="f_in" placeholder="Fecha Ingreso" required>

                    <label class="control-label">Fecha Salida</label>
                    <input type="date" class="form-control" id="f_sale" name="f_sale" placeholder="Fecha Salida" required>
                </div>    
            </div><br><br>
            <div class="container">
