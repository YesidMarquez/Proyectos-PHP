    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-3  ">
                ...
                <div class="btn-group">
                    <a href="../tip_cons/planta.php" class="btn btn-primary ">ATRAS</a>
                    ...
                    <?php } else { ?>
                        ...
                        <a class="btn btn-danger  text-dark" data-toggle="popover" title="Datos de Inactividad" data-content="Renuncia el  <?php echo $row1['fecha_vencimiento']; ?> ">INACTIVO</a>
                    <?php } ?>
            ...
            <div class="col-sm-6 ">
                <div class=" container">
                    <button type="button" class="btn btn-primary" data-toggle="collapse" data-target="#demo">DATOS PERSONALES</button>
                    <div id="demo" class="collapse">
                        <a class="list-group-item list-group-item-success" >                              <big><strong>Ciudad Nacimiento:    </strong></big> <?php echo $row1['ciudad_nacimiento']; ?></a>
            ...
            <div class="col-sm-3">
                <iframe src="https://www.supervigilancia.gov.co/?idcategoria=61193"  width="304" height="550">
