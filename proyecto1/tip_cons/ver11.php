                    ...
                    <div class="card-body">
                        ...
                        <div class="list-group">
                            <a class="list-group-item list-group-item-info" class="list-group-item list-group-item-action" >
                               <big><strong>Ciudad Nacimiento:</strong></big> <?php echo $row1['ciudad_nacimiento']; ?></a>
                            <a class="list-group-item list-group-item-info" class="list-group-item list-group-item-action">
                                <big><strong>Expedicion Cedula:</strong></big> <?php echo $row1['ciudad_expedicion']; ?></a>
                            <a class="list-group-item list-group-item-info" class="list-group-item list-group-item-action">
                                <big><strong>Ciudad/Residencia:</strong></big> <?php echo $row1['direccion']; ?>." ".<?php echo $row1['ciudad_residencia']; ?></a>
                        </div>
