<htm lang="es">
	...
	<body><font face="Comic Sans MS,verdana">
		...
		<center>
			...
			<div class="col-xs-12 col-sm-4" data-reactid="20">
    			<div class="Card" data-reactid="37">
    				<figure data-reactid="38">
    		...
    		<div class="col-xs-12 col-sm-4" data-reactid="47">
    			<div class="Card" data-reactid="59">
    				<figure data-reactid="60">
    					<a href="tip_cons/cursos.php"  class="Card-link" data-reactid="68"><img src="imagenes/control.jpg" alt="Desarrollo con Java " width="100" height="100" data-reactid="61" class="rounded-circle"></a>
    				</figure>
    				<div class="Card-info" data-reactid="62">
