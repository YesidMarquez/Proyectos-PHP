<?php
    ...
    $row1 = $resultado1->fetch_array(MYSQLI_ASSOC);
     /*-----------------------------------------------------------------------*/
    $sql2 = "SELECT cu.descripcion,cc.nro_curso,cc.fecha_vencimiento, cc.academia_nit FROM control_cursos cc, cursos cu  WHERE cc.empleado_id='$id' and cc.curso_id=cu.id_cursos ";
        ...
        <div class="container">
            ...
            <form class="form-horizontal" method="POST" action="../tip_cons/actualizar_cursos.php" autocomplete="off">
                <div class="form-group">
                    ...
                    <label for="nombre" class="col-sm-2 control-label">Nit Academia</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="ACA" name="ACA" placeholder="Academia" value="<?php echo $row2['academia_nit']; ?>" >
                    </div>
