...
$sql2 = "SELECT  count(*) as conteo FROM `movil` where registro BETWEEN '$fecha_ini' AND '$fecha_fin' and  usuario_cedula=$idAgente";
...
<htm lang="es">
    ...
    <body>
        <nav class="navbar navbar-expand-sm bg-info navbar-info fixed-top">
            <!-- Brand/logo -->
            <a class="nav-link" href="#"><marquee scrollamount="3"><img  class="" src="../../imagenes/logos/logo2Navidad.png" title="Personal" width="110" height="80"></img><img  class="" src="../../imagenes/logos/tigoune.png" title="Personal" width="65" height="40"></img></marquee></a>
            <!-- Links -->
            <ul class="navbar-nav">
                <?php if ($nivel==2) {?>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="../../imagenes/manuales/Manual Usuario Agente.pdf">
                        <img  class="menu" src="../../imagenes/iconos/manual02.png" title="Manual Agente" width="65" height="65">
                        </img>
                    </a>
                </li>
                <?php } ?>
            ...
            <div class="container fuente"> 
                ...
                <div class="titulo">
                    <ul class="list-group">
                        <center><img  class="menu" src="../../imagenes/iconos/navidad.gif"  width="70" height="70"></center>
